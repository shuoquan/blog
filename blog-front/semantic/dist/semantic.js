      ...
      module = {
        ...
        get: {
          ...
          field: function (identifier) {
            ...
            if ($field.filter('#' + identifier).length > 0) {
              ...
              '[data-' + metadata.validate + '="' + identifier + '"]').length
              > 0) {
              return $field.filter(
        ...
        remove: {
          rule: function (field, rule) {
            ...
            if (validation[field] == undefined || !$.isArray(
              validation[field].rules)) {
              return;
            }
                ...
                if (pressedKey == keys.upArrow) {
                  $nextItem = (hasSelectedItem && inVisibleMenu)
                    ? $selectedItem.prevAll(
                      selector.item + ':not(' + selector.unselectable + ')').eq(
                      0)
                    : $item.eq(0)
                  ;
            ...
            if (shouldSearch) {
              ...
              .each(function () {
                ...
                if (isMultiple) {
                  ...
                  module.verbose(
                    'Ambiguous dropdown value using strict type check', $choice,
                    value);
        ...
        set: {
          ...
          direction: function ($menu) {
            if (settings.direction == 'auto') {
              ...
              if (!module.is.leftward($menu) && !module.can.openRightward(
                $menu)) {
        ...
        has: {
          ...
          valueIgnoringCase: function (value) {
            ...
            $.each(values, function (index, existingValue) {
              if (String(value).toLowerCase() == String(
        ...
        is: {
          ...
          alreadySetup: function () {
            return ($module.is('select') && $module.parent(
              selector.dropdown).data(moduleNamespace) !== undefined
    ...
    dropdown: function (select) {
      ...
      $.each(select.values, function (index, option) {
        html += (option.disabled)
          ...
          + option.name + '</div>'
          : '<div class="item" data-value="' + option.value + '">' + option.name
          + '</div>'
        ;
      });
      html += '</div>';
      ...
      module = {
        ...
        bind: {
          ...
          scrollLock: function () {
            ...
            $dimmable.get(0).addEventListener('touchmove',
              module.event.preventScroll, {passive: false});
          }
        },

        unbind: {
          scrollLock: function () {
            $dimmable.get(0).removeEventListener('touchmove',
              module.event.preventScroll, {passive: false});
          }
        },
        ...
        event: {
          ...
          resize: function () {
            if ($dimmable.dimmer('is active') && (module.is.animating()
              || module.is.active())) {
      ...
      module = {
        ...
        stage: {
          ...
          above: function () {
            var
              box = {
                origin: (($activeSide.outerHeight(true) - $nextSide.outerHeight(
                  true)) / 2),
                depth: {
          ...
          inlineCSS: function () {
            ...
            if (direction === 'left' || direction === 'right') {
              ...
              style += ''
                + ' .ui.visible.' + direction + '.sidebar ~ .fixed,'
                + ' .ui.visible.' + direction + '.sidebar ~ .pusher {'
                + '   -webkit-transform: translate3d(0, ' + distance[direction]
                + 'px, 0);'
                + '           transform: translate3d(0, ' + distance[direction]
                + 'px, 0);'
                + ' }'
              ;
            }
